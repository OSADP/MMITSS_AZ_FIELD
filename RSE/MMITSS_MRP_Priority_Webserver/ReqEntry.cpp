...
ReqEntry::ReqEntry(char * vehID, int vehClass, float eta, int phase, float mgreen,int absTime,int split_phase, int inlane,int outlane, int strhour, int strmin, int strsec, int endhour, int endmin , int endsec, int vehstate, char* cinlane,char* coutlane,int imsgcnt,int IsCanceled)
{
	strcpy(VehID,vehID);
	VehClass=vehClass;
	ETA=eta;
