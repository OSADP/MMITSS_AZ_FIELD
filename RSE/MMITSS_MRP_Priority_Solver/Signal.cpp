...
void Phase::UpdatePhase(PhaseStatus newPhaseStatus)
{
	...
	*/
    ...
    {
		//cout<<ConfigIS.MP_Ring[i]<<endl;
		//cout<<CurPhase[1-ConfigIS.MP_Ring[i]];
		//cout<<ConfigIS.MP_Relate[i]<<endl;
    ...
    for(int i=0;i<R2No;i++)
    {
        ...
        dGlobalGmax[i+4]=ConfigIS.Gmax[k+4];
    }
