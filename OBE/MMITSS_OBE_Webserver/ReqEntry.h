...
{
public:
	int VehID;			//  The ID of the vehicle
...
public:
	ReqEntry();
	ReqEntry(int vehID, int VehClass, float eta, int phase,float mgreen, int absTime,int split_phase,int inlane,int outlane, int strhour, int strmin, int strsec, int endhour, int endmin , int endsec, int vehstate, char* cinlane,char* coutlane,int iMsgCnt);
