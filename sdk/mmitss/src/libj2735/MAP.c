...
static asn_TYPE_member_t asn_MBR_MAP_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MAP, msgID),
	...
	{ ATF_POINTER, 3, offsetof(struct MAP, name),
	...
	{ ATF_POINTER, 2, offsetof(struct MAP, layerType),
	...
	{ ATF_POINTER, 1, offsetof(struct MAP, layerID),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MAP, intersections),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct MAP, dataParameters),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MAP, crc),
...
static ber_tlv_tag_t asn_DEF_MAP_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_MAP_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* msgID at 4 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* msgCnt at 5 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* name at 6 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* layerType at 7 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* layerID at 8 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* intersections at 9 */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* dataParameters at 18 */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 } /* crc at 20 */
};
static asn_SEQUENCE_specifics_t asn_SPC_MAP_specs_1 = {
	sizeof(struct MAP),
