...
static asn_TYPE_member_t asn_MBR_Intersection_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Intersection, preemptZones),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Intersection, priorityZones),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		0,
...
static asn_TYPE_tag2member_t asn_MAP_Intersection_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* name at 60 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* id at 61 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* refPoint at 65 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* refInterNum at 69 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* orientation at 72 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* laneWidth at 75 */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* type at 78 */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 }, /* approaches at 80 */
    { (ASN_TAG_CLASS_CONTEXT | (8 << 2)), 8, 0, 0 }, /* preemptZones at 83 */
    { (ASN_TAG_CLASS_CONTEXT | (9 << 2)), 9, 0, 0 } /* priorityZones at 89 */
};
